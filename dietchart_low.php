...
<head>
  ...
  <title>Low Calorie Diet Chart - Nutri-Track Academia</title>
...
<div class="page-wrapper">
    <div id="diet-chart-container">
        ...
        <div class="info-box">
            <strong>Total Calorie Requirement Range:</strong> 1200–1600 kcal/day<br />
            <strong>Campus Meal Target:</strong> 60–65% of daily intake = 720-1040 kcal/day<br />
            <em>Dinner is assumed to be taken at home, covering the rest 35-40%</em>
        </div>

        <h2>Low Calorie Diet Chart (On Campus: 720–1040 kcal)</h2>
        ...
        <div id="chart-section">
            ...
            <tbody>
                <tr><td>Saturday</td><td>1 Paratha (180) + Boiled Egg (75)</td><td>Plain Rice (200) + Chicken Curry (220)</td><td>Vegetable Patties (150)</td><td>Lemon Juice (60)</td><td>885</td></tr>
                <tr><td>Sunday</td><td>Bread (70) + Jam (60) + Milk (100)</td><td>Plain Rice (200) + Daal (150)</td><td>Seasonal Fruits (90)</td><td>Coffee (130)</td><td>800</td></tr>
                <tr><td>Monday</td><td>Khichuri (350)</td><td>Mixed Veg (100) + Fried Egg (90)</td><td>Chotpoti (250)</td><td>Milk Tea (110)</td><td>900</td></tr>
                <tr><td>Tuesday</td><td>2 Roti (140) + Lentils Curry (180)</td><td>Plain Rice (200) + Fish Curry (250)</td><td>Shingara (130)</td><td>Black Tea (5)</td><td>905</td></tr>
                <tr><td>Wednesday</td><td>Paratha (180) + Mixed Veg (100)</td><td>Biryani (350) + Salad (50)</td><td>Samucha (120)</td><td>Green Coconut Water (60)</td><td>860</td></tr>
            </tbody>
            </table>
        </div>

        <div class="tips-box">
            <h3>Tips for Students Needing Low Calorie</h3>
            <ul>
            <li>Drink water regularly to avoid dehydration.</li>
            <li>Stick to balanced portions even when dining outside.</li>
            <li>Choose fruits or grilled items over fried snacks.</li>
            <li>Ensure regular sleep and avoid skipping meals.</li>
            </ul>
        </div>
    </div>

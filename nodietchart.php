...
<head>
    ...
    <title>Diet Chart Unavailable</title>
...
<body>
    <div class="wrapper">
    <div class="intro">
            <h2>Diet Chart Unavailable</h2>
            <p>Unfortunately, we do not provide diet charts for calorie requirement in this range.<br><br><a href="bmi_bmr.php" class="btn btn-dark">Calculate BMI/BMR</a></p>
    </div>

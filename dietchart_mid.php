...
<head>
  ...
  <title>Mid Calorie Diet Chart - Nutri-Track Academia</title>
...
<div class="page-wrapper">
    <div id="diet-chart-container">
        ...
        <div class="info-box">
            <strong>Total Calorie Requirement Range:</strong> 1600–1900 kcal/day<br />
            <strong>Campus Meal Target:</strong> 60–65% of daily intake = 960–1235 kcal/day<br />
            <em>Dinner is assumed to be taken at home, covering the rest 35–40%</em>
        </div>

        <h2>Mid Calorie Diet Chart (On Campus: 960–1235 kcal)</h2>
        ...
        <div id="chart-section">
            ...
            <tbody>
                <tr><td>Saturday</td><td>Paratha (180) + Egg Omelette (90)</td><td>Plain Rice (200) + Beef Curry (300)</td><td>Chicken Sandwich (300)</td><td>Lassi (150)</td><td>1220</td></tr>
                <tr><td>Sunday</td><td>Bread (70) + Jam (60) + Boiled Egg (75)</td><td>Plain Rice (200) + Chicken Curry (220) + Daal (150)</td><td>Fried Chicken (250) + Seasonal Fruits (90)</td><td>Milk Tea (110)</td><td>1225</td></tr>
                <tr><td>Monday</td><td>Khichuri (350) + Egg Omelette (90)</td><td>Fried Rice (300) + Mixed Veg (100)</td><td>Noodles (350)</td><td>Black Tea (5)</td><td>1195</td></tr>
                <tr><td>Tuesday</td><td>2 Roti (140) + Lentils Curry (180)</td><td>Plain Rice (200) + Fish Curry (250)</td><td>Burger (400)</td><td>Green Coconut Water (60)</td><td>1230</td></tr>
                <tr><td>Wednesday</td><td>Paratha (180) + Mixed Veg (100)</td><td>Biryani (350) + Salad (50)</td><td>Chotpoti (250) + Seasonal Fruits (90)</td><td>Coffee (120)</td><td>1140</td></tr>
            </tbody>
            </table>
        </div>

        <div class="tips-box">
            <h3>Tips for Students Needing Mid Calorie</h3>
            <ul>
            <li>Balance protein with carbs in every major meal.</li>
            <li>Opt for healthy fats like nuts and seeds occasionally.</li>
            <li>Fruits and dairy drinks are great for mid-day energy.</li>
            <li>Watch portions in biryani, burgers, and fried items.</li>
            </ul>
        </div>
    </div>

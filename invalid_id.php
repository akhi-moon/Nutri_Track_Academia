...
<body>
    <div class="wrapper">
    <div class="intro">
            <h2>Account for student already exists</h2>
            <p>Please log in with existing account or sign up for new student.<br><br><a href="stu_sign_log.php" class="btn btn-dark">SIGN UP</a></p>
    </div>

...
<head>
  ...
  <title>High Calorie Diet Chart - Nutri-Track Academia</title>
...
<div class="page-wrapper">
    <div id="diet-chart-container">
        ...
        <div class="info-box">
            <strong>Total Calorie Requirement Range:</strong> 1900–2300 kcal/day<br />
            <strong>Campus Meal Target:</strong> 60–65% of daily intake = 1140–1500 kcal/day<br />
            <em>Dinner is assumed to be taken at home, covering the rest 35–40%</em>
        </div>

        <h2>High Calorie Diet Chart (On Campus: 1140–1500 kcal)</h2>
        ...
        <div id="chart-section">
            ...
            <tbody>
                <tr><td>Saturday</td><td>2 Paratha (360) + Egg Omelette (90) + Milk (100)</td><td>Biryani (350) + Salad (50)</td><td>Chicken Sandwich (300) + Seasonal Fruits (90)</td><td>Lassi (150)</td><td>1490</td></tr>
                <tr><td>Sunday</td><td>Bread (70) + Jam (60) + Boiled Egg (75)</td><td>Fried Rice (300) + Chicken Curry (220) + Daal (150)</td><td>Fried Chicken (250) + Seasonal Fruits (90)</td><td>Milk Tea (110)</td><td>1325</td></tr>
                <tr><td>Monday</td><td>Khichuri (350) + Boiled Egg (75)</td><td>Fried Rice (300) + Beef Curry (300) + Mixed Veg (100)</td><td>Fuchka (220)</td><td>Soft Drink (150)</td><td>1495</td></tr>
                <tr><td>Tuesday</td><td>2 Roti (140) + Lentils Curry (180) + Jam (60) + Milk (100)</td><td>Plain Rice (200) + Fish Curry (250)</td><td>Burger (400)</td><td>Green Coconut Water (60)</td><td>1390</td></tr>
                <tr><td>Wednesday</td><td>Paratha (180) + Mixed Veg (100) + Milk (100)</td><td>Biryani (350) + Fried Egg (90) + Salad (50)</td><td>Chotpoti (250) + Seasonal Fruits (90)</td><td>Coffee (120)</td><td>1330</td></tr>
            </tbody>
            </table>
        </div>

        <div class="tips-box">
            <h3>Tips for Students needing High Calorie</h3>
            <ul>
            <li>Include calorie-dense foods like dairy, nuts, and lean meats.</li>
            <li>Don’t skip snacks – they’re essential to meet your target.</li>
            <li>Drink full-cream milk or lassi for extra energy.</li>
            <li>Balance fried items with vegetables and fruits.</li>
            </ul>
        </div>
    </div>
